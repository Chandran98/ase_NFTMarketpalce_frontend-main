...
export default function Subscription() {
  return (
    <>
      <div
        className="nc-SectionSubscribe2 p-32 relative flex flex-col lg:flex-row lg:items-center"
      ...
      >
        <div className="flex-shrink-0 mb-10 lg:mb-0 lg:mr-10 lg:w-2/5">
          ...
          <form className="mt-10 relative max-w-sm">
            ...
            />
            <button
              className="nc-ButtonCircle flex items-center justify-center rounded-full !leading-none disabled:bg-opacity-70 bg-primary-6000 hover:bg-primary-700 text-black  absolute transform top-1/2 -translate-y-1/2 right-1  w-9 h-9  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000 dark:focus:ring-offset-0"
              type="submit"
            >
              <svg
